...
def describe_game(name):
    ...
    # then they are a new players and we need to get their name
    if name !="":
...
def nice_mean(nice,mean,name):
    ...
    while stop:
        ...
        pick = input("\nA stranger appraoches you for a \n conversation. Will you be nice \nor mean? (N/M) \n >>>: ").lower()
        if pick == "n":
...
def win(nice,mean,name):
    print("\nNice job, you win! \nEveryone loves you xoxoxo")
    again(nice,mean,name)


def lose(nice,mean,name):
    #substitute the {} wildcards with our variable value
    print("\nAhhh too bad, game over!\n you a meanie")
    #call again function and pass in our variables
    again(nice,mean,reset)
